 ...
 * RFC8032 5.1.5
 */
module.exports.getPublicKey = function getPublicKey(privateKey) {
 ...
 * RFC8032 5.1.6
 */
module.exports.sign = function sign(message, privateKey) {
 ...
 */
 module.exports.verify = function verify(sig, message, publicKey) {
  message = ensureBytes(message)
 ...
 */
 module.exports.getSharedSecret = function getSharedSecret(privateKey, publicKey) {
